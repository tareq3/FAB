...
public class FloatingActionButton extends ImageButton {
  ...
  public int fab_mti_size_Custom;
  public int fab_mti_icon_Size;
  public int fab_mti_shadow_Offset;
  public int fab_mti_shadow_Radius;
  ...
  void init(Context context, AttributeSet attributeSet) {
    ...
    fab_mti_icon_Size =(int) attr.getDimension(R.styleable.FloatingActionButton_fab_mti_icon_size, getDimension(R.dimen.fab_icon_size));
    fab_mti_size_Custom=(int) attr.getDimension(R.styleable.FloatingActionButton_fab_mti_size_custom, getDimension(R.dimen.fab_size_custom));
    fab_mti_shadow_Offset=(int) attr.getDimension(R.styleable.FloatingActionButton_fab_mti_shadow_offset, getDimension(R.dimen.fab_shadow_offset));
    fab_mti_shadow_Radius=(int) attr.getDimension(R.styleable.FloatingActionButton_fab_mti_shadow_radius,getDimension(R.dimen.fab_shadow_radius));
    ...
    updateCircleSize();
    mShadowRadius = fab_mti_shadow_Radius;
    mShadowOffset = fab_mti_shadow_Offset;
    updateDrawableSize();
  ...
  private void updateCircleSize() {
   ...
   if(mSize==SIZE_NORMAL || mSize==SIZE_MINI){
     mCircleSize = getDimension(mSize == SIZE_NORMAL ? R.dimen.fab_size_normal : R.dimen.fab_size_mini);

   }
   else if(mSize==SIZE_CUSTOM){
     mCircleSize=fab_mti_size_Custom;
   }
   /* mCircleSize =
 ...
 */ }
  ...
  */
  ...
  void updateBackground() {
    ...
    int iconOffset = (int) (mCircleSize - fab_mti_icon_Size) / 2;
