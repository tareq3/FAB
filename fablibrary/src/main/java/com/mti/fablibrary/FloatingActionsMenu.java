...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private void init(Context context, AttributeSet attributeSet) {
    ...
    AddFloatingActionButton.fab_mti_plus_icon_size=(int)attr.getDimension(R.styleable.FloatingActionsMenu_fab_mti_plus_icon_Size, getDimension(R.dimen.fab_plus_icon_size));
    AddFloatingActionButton.fab_mti_plus_icon_stroke=(int)attr.getDimension(R.styleable.FloatingActionsMenu_fab_mti_plus_icon_Stroke, getDimension(R.dimen.fab_plus_icon_stroke));
