...
public class AddFloatingActionButton extends FloatingActionButton {
  int mPlusColor;
 public static int fab_mti_plus_icon_size;
  public static  int fab_mti_plus_icon_stroke;
  ...
  Drawable getIconDrawable() {
    ...
    final float plusSize = fab_mti_plus_icon_size;
    final float plusHalfStroke = fab_mti_plus_icon_stroke / 2f;
